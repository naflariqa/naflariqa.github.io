...
// Blok kode yang akan dipanggil jika fetch berhsil
...
function getArticles() {
    ...
    fetch(base_url + "articles").then(status).then(json).then(function(data) {
...
function getArticleById() {
    return new Promise(function (resolve, reject) {
            ...
            caches.match(base_url + "article/" + idParam).then(function (response) {
                if (response) {
                    response.json().then(function (data) {
                        ...
                        // Kirimm objek data hasil parsing json agar bisa disimpan ke indexed db
                        resolve(data);
                    });
                }
            });
        ...
        fetch(base_url + "article/" + idParam).then(status).then(json).then(function (data) {
            // Objek JavaScript dari response.json() masuk lewat variabel data.
            console.log(data);
            // Menyusun komponen card artikel secara dinamis
            var articleHTML = `
